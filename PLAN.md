...
- [ ] Grant the `BUILD_LOCK_CONSUMER_APP_*` App its Contents-write and
      Pull-requests-write installation on the enrolled repositories
      (maintainer action in App settings); the workflow fails visibly until
      then.
