...
| `missing-unity-editor-check` | Invoke the pinned `ensure-unity-editor` action with the exact inputs in the reviewed prefix: only the current-PR-head guard may precede it. See item 3. |
